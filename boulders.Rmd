...
DT::datatable(mydata2[,c(1:8,14)], colnames = c('Route Name', 'Climber', 'Consensus VGrade', 'FA', 'Country', 'Area', 'Date', 'Suggested VGrade by Climber', 'Repeated?'), options = list(pageLength = 900, autoWidth = TRUE))
```
